          ...
          items: [
            {
              ...
              description: "Forecast safety hazards and operational risks before they occur",
              href: "/ehs-ai/predictive-risk-modeling",
              icon: Brain,
              featured: true,
              badge: "Popular",
              color: "safeglobal",
            ...
            {
              label: "IoT Data Fusion",
              description: "Unify environmental and safety sensor streams for real-time insights",
              href: "/ehs-ai/iot-data-fusion",
              icon: Cpu,
              color: "sky",
            },
            {
              label: "Automated Incident Capture",
              description: "Smart incident logging with computer vision and root-cause analysis",
              href: "/ehs-ai/automated-incident-capture",
              icon: Eye,
              color: "rose",
            },
            {
              label: "Smart EHS Auditing",
              description: "Automate compliance checks and digitize audit workflows with AI",
              href: "/ehs-ai/smart-ehs-auditing",
              icon: FileCheck,
              color: "amber",
            },
          ],
